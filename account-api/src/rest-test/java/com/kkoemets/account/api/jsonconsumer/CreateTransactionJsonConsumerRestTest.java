...
public class CreateTransactionJsonConsumerRestTest extends AccountApiRestTest {
    ...
    public void successfullyConsume() {
        ...
        String amount = "1.00";
        Long accountId = Long.valueOf(createAccountResult.get("accountId").toString());
        String description = "test description";
        Map<String, Object> result = post("/api/v1/transactions",
                Map.of(
                        "accountId", accountId,
                        "amount", amount,
                        "currency", currency,
        ...
        assertThat(result.get("accountId").toString(), is(accountId.toString()));
